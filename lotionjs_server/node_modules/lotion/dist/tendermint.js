...
function createTendermintProcess(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var opts, shouldUseAuth_1, cfgPath, configToml, bogusId_1, privValPath, newValidatorJson, oldValidatorJson, tendermintProcess;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                     ...
                     */
                    if (keyPath) {
                        privValPath = path_1.join(home, 'config', 'priv_validator.json');
